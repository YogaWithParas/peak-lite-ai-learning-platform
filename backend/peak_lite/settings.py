...
WSGI_APPLICATION = "peak_lite.wsgi.application"

# PostgreSQL configuration via environment variables (see .env.example).
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.environ.get("DB_NAME", "peak_lite_db"),
